...
ipk: $(TARGET)
	...
	@tar --owner=0 --group=0 -czvf /tmp/.handy320-ipk/data.tar.gz -C /tmp/.handy320-ipk/root/ .
	@echo 2.0 > /tmp/.handy320-ipk/debian-binary
	@ar r handy320/handy320.ipk /tmp/.handy320-ipk/control.tar.gz /tmp/.handy320-ipk/data.tar.gz /tmp/.handy320-ipk/debian-binary
